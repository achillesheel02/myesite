...
STATIC_ROOT = os.path.join(PROJECT_ROOT, 'saleor','staticfiles')
STATIC_URL = '/static/'
STATICFILES_DIRS = [
...
SECRET_KEY = os.environ.get('SECRET_KEY', 'cg#p$g+j9tax!#a3cup@1$8obt2_+&k3q+pmu)5%asj6(&^%*):Nuo;l')
...
CHECKOUT_PAYMENT_CHOICES = [
    ('default', 'Cash/MPESA On Delivery/Collection'),
    ]
...
ALLOWED_HOSTS = ['stormy-waters-49099.herokuapp.com','127.0.0.1']
